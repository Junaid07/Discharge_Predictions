...
zip_path = "lstm_discharge_model_2to1.zip"
model_path = "lstm_discharge_model_2to1.keras"

# Unzip only if model file not already extracted
...
# === Load model with custom initializer fix ===
#model = load_model("lstm_discharge_model_2to1.keras", custom_objects={"Orthogonal": Orthogonal})
